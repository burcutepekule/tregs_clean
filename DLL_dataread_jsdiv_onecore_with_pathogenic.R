...
if(length(inds2read)>0){
  ...
  for (i_idx in seq_along(inds2read)){
    ...
    if(any(file.info(files_to_check)$size<100000)){
      ...
      full_data_comparison = results %>% dplyr::select(param_set_id, control, sterile, macspec_on, tregs_on, randomize_tregs, rep_id, t, time_ss, epithelial_score)
      ...
      scores_0_1_1_0_0_keep = c()  # control_0_sterile_1_macspec_1_tregs_0_trnd_0
      ...
      for (rep in min_reps:max_reps) {
        ...
        if(!any(is.na(time_ss_vec))){
          ...
          scores_0_1_1_0_0 = full_data_comparison_scores_0_1_1_0_0$epithelial_score[time_ss_0_1_1_0_0:t_max_ind]

          # Accumulate scores
          scores_1_0_0_0_0_keep = c(scores_1_0_0_0_0_keep, scores_1_0_0_0_0)
          scores_1_1_0_0_0_keep = c(scores_1_1_0_0_0_keep, scores_1_1_0_0_0)

          scores_0_0_0_0_0_keep = c(scores_0_0_0_0_0_keep, scores_0_0_0_0_0)
          scores_0_0_0_1_0_keep = c(scores_0_0_0_1_0_keep, scores_0_0_0_1_0)
          scores_0_0_0_1_1_keep = c(scores_0_0_0_1_1_keep, scores_0_0_0_1_1)
          scores_0_0_1_0_0_keep = c(scores_0_0_1_0_0_keep, scores_0_0_1_0_0)

          scores_0_1_0_0_0_keep = c(scores_0_1_0_0_0_keep, scores_0_1_0_0_0)
          scores_0_1_0_1_0_keep = c(scores_0_1_0_1_0_keep, scores_0_1_0_1_0)
          scores_0_1_0_1_1_keep = c(scores_0_1_0_1_1_keep, scores_0_1_0_1_1)
          scores_0_1_1_0_0_keep = c(scores_0_1_1_0_0_keep, scores_0_1_1_0_0)
          ...
          comparison_results = data.frame(
            ...
            injury_type  = c("pathogenic", "sterile", "pathogenic", "pathogenic", "pathogenic", "pathogenic", "sterile", "sterile", "sterile", "sterile"),
            ...
            ss_start     = c(time_ss_1_0_0_0_0, time_ss_1_1_0_0_0,
                             time_ss_0_0_0_0_0, time_ss_0_0_0_1_0, time_ss_0_0_0_1_1, time_ss_0_0_1_0_0,
                             time_ss_0_1_0_0_0, time_ss_0_1_0_1_0, time_ss_0_1_0_1_1, time_ss_0_1_1_0_0),
            mean_score   = c(mean(scores_1_0_0_0_0), mean(scores_1_1_0_0_0),
                                   mean(scores_0_0_0_0_0), mean(scores_0_0_0_1_0), mean(scores_0_0_0_1_1), mean(scores_0_0_1_0_0),
                                   mean(scores_0_1_0_0_0), mean(scores_0_1_0_1_0), mean(scores_0_1_0_1_1), mean(scores_0_1_1_0_0))
          )
      ...
      # ===================================================================
      # JS Divergence comparisons - using epithelial score vectors
      # ===================================================================

      # Control vs tregs OFF (baseline effect of ROS/injury)
      all_comparison_results_reps$d_ctrl_vs_test_sterile   = calculate_js_divergence(scores_1_1_0_0_0_keep, scores_0_1_0_0_0_keep, method = "fd")[1]
      all_comparison_results_reps$d_ctrl_vs_test_pathogen  = calculate_js_divergence(scores_1_0_0_0_0_keep, scores_0_0_0_0_0_keep, method = "fd")[1]

      # NEW: Explicit control pathogenic vs tregs off pathogenic comparison
      # This compares control condition (no ROS) vs test condition (with ROS) with tregs OFF for pathogenic injury
      all_comparison_results_reps$d_ctrl_pathogenic_vs_tregsoff_pathogenic = calculate_js_divergence(scores_1_0_0_0_0_keep, scores_0_0_0_0_0_keep, method = "fd")[1]

      # Tregs ON vs OFF (effect of tregs)
      all_comparison_results_reps$d_tregs_on_vs_off_sterile  = calculate_js_divergence(scores_0_1_0_1_0_keep, scores_0_1_0_0_0_keep, method = "fd")[1]
      all_comparison_results_reps$d_tregs_on_vs_off_pathogen = calculate_js_divergence(scores_0_0_0_1_0_keep, scores_0_0_0_0_0_keep, method = "fd")[1]

      # Tregs random vs targeted (specificity of tregs)
      all_comparison_results_reps$d_tregs_rnd_vs_nrnd_sterile  = calculate_js_divergence(scores_0_1_0_1_1_keep, scores_0_1_0_1_0_keep, method = "fd")[1]
      all_comparison_results_reps$d_tregs_rnd_vs_nrnd_pathogen = calculate_js_divergence(scores_0_0_0_1_1_keep, scores_0_0_0_1_0_keep, method = "fd")[1]

      # Perfect macrophage vs tregs OFF (macrophage specificity effect)
      all_comparison_results_reps$d_macspec_vs_tregs_off_sterile       = calculate_js_divergence(scores_0_1_1_0_0_keep, scores_0_1_0_0_0_keep, method = "fd")[1]
      all_comparison_results_reps$d_macspec_vs_tregs_off_base_pathogen = calculate_js_divergence(scores_0_0_1_0_0_keep, scores_0_0_0_0_0_keep, method = "fd")[1]

      # Perfect macrophage vs tregs ON (comparing two rescue mechanisms)
      all_comparison_results_reps$d_macspec_vs_tregs_on_sterile  = calculate_js_divergence(scores_0_1_1_0_0_keep, scores_0_1_0_1_0_keep, method = "fd")[1]
      all_comparison_results_reps$d_macspec_vs_tregs_on_pathogen = calculate_js_divergence(scores_0_0_1_0_0_keep, scores_0_0_0_1_0_keep, method = "fd")[1]


      # ===================================================================
      # Mean epithelial scores across all replicates (post-steady state)
      # ===================================================================

      # Control
      all_comparison_results_reps$mean_ctrl_sterile  = mean(scores_1_1_0_0_0_keep)
      all_comparison_results_reps$mean_ctrl_pathogen = mean(scores_1_0_0_0_0_keep)

      # Test - tregs OFF
      all_comparison_results_reps$mean_tregs_off_sterile  = mean(scores_0_1_0_0_0_keep)
      all_comparison_results_reps$mean_tregs_off_pathogen = mean(scores_0_0_0_0_0_keep)

      # Test - tregs ON (targeted)
      all_comparison_results_reps$mean_tregs_on_sterile  = mean(scores_0_1_0_1_0_keep)
      all_comparison_results_reps$mean_tregs_on_pathogen = mean(scores_0_0_0_1_0_keep)

      # Test - tregs ON (random)
      all_comparison_results_reps$mean_tregs_rnd_sterile  = mean(scores_0_1_0_1_1_keep)
      all_comparison_results_reps$mean_tregs_rnd_pathogen = mean(scores_0_0_0_1_1_keep)

      # Test - perfect macrophage
      all_comparison_results_reps$mean_macspec_sterile  = mean(scores_0_1_1_0_0_keep)
      all_comparison_results_reps$mean_macspec_pathogen = mean(scores_0_0_1_0_0_keep)

      # ===================================================================
      # SD epithelial scores across all replicates (post-steady state)
      # ===================================================================

      # Control
      all_comparison_results_reps$sd_ctrl_sterile  = sd(scores_1_1_0_0_0_keep)
      all_comparison_results_reps$sd_ctrl_pathogen = sd(scores_1_0_0_0_0_keep)

      # Test - tregs OFF
      all_comparison_results_reps$sd_tregs_off_sterile  = sd(scores_0_1_0_0_0_keep)
      all_comparison_results_reps$sd_tregs_off_pathogen = sd(scores_0_0_0_0_0_keep)

      # Test - tregs ON (targeted)
      all_comparison_results_reps$sd_tregs_on_sterile  = sd(scores_0_1_0_1_0_keep)
      all_comparison_results_reps$sd_tregs_on_pathogen = sd(scores_0_0_0_1_0_keep)

      # Test - tregs ON (random)
      all_comparison_results_reps$sd_tregs_rnd_sterile  = sd(scores_0_1_0_1_1_keep)
      all_comparison_results_reps$sd_tregs_rnd_pathogen = sd(scores_0_0_0_1_1_keep)

      # Test - perfect macrophage
      all_comparison_results_reps$sd_macspec_sterile  = sd(scores_0_1_1_0_0_keep)
      all_comparison_results_reps$sd_macspec_pathogen = sd(scores_0_0_1_0_0_keep)
