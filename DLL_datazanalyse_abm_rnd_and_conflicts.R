...
# data_suffix    = '_20' # empty for 100 reps, _10 for 10 reps
...
df_comparisons_inj  = df_comparisons %>% dplyr::filter(injury_type==inj_type)

condition_subt_from = 'tregs_on'
condition_subt      = 'tregs_off'
jensen_distance     = 'tregs_on_vs_off'
df_comparisons_in   = df_comparisons_inj
...
## 17% does not get affected by randomization - are these the ones that have low treg_disc_efficiency?
