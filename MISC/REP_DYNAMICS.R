#### IN THE RPAT VERSION - AMPR killing
# amp_killing = amp_kill_rate*(epithelium$level_injury)*(1-epithelium$level_injury/max_level_injury) # both scaled by the level of injury and leftover healthy cells 
# pat_lumen = pat_lumen*(1+r_pat*(1-pat_lumen/pat_lumen_max)-amp_killing)
