...
param_bounds = list(
  diffusion_speed_microbe = c(0, 0.12), 
  decay_rate_microbe      = c(0, 0.75), 
  diffusion_speed_macro   = c(0, 0.12), 
  ...
  add_PAMPs = c(0, 0.5),
  ros_decay   = c(0, 0.25),
  DAMPs_decay = c(0, 0.25),
  SAMPs_decay = c(0, 0.25),
  PAMPs_decay = c(0, 0.25),
  ...
  activity_engulf_M1_baseline = c(0.15, 0.50),
